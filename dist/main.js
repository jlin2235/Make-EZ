...
/* harmony import */ var _styles_search_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./styles/search.scss */ "./src/styles/search.scss");
...
/* harmony import */ var _scripts_search__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts/search */ "./src/scripts/search.js");
...
document.addEventListener('DOMContentLoaded', function () {
  Object(_scripts_navbar__WEBPACK_IMPORTED_MODULE_3__["navbarExpand"])();
  Object(_scripts_search__WEBPACK_IMPORTED_MODULE_4__["testSearch"])();
});
...
/*!*******************************!*\
  !*** ./src/scripts/navbar.js ***!
  \*******************************/
/*! exports provided: navbarExpand */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "navbarExpand", function() { return navbarExpand; });
var navbarExpand = function navbarExpand() {
  var navbarExpandButton = document.getElementById('navbar-button');
  ...
  navbarExpandButton.addEventListener('click', function () {
    var navbarButtonLi = document.getElementById('button-li');
...
/*!*******************************!*\
  !*** ./src/scripts/search.js ***!
  \*******************************/
/*! exports provided: testSearch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "testSearch", function() { return testSearch; });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);


var getRecipeData = function getRecipeData() {
  debugger;
  var YOUR_APP_ID = '6f5507b6';
  var YOUR_APP_KEY = '50592ebb8250b99cec1f597f0426fdcf';
  var searchValue = document.getElementById('search-bar').value;
  var edamam = "https://api.edamam.com/search?q=".concat(searchValue, "&app_id=").concat(YOUR_APP_ID, "&app_key=").concat(YOUR_APP_KEY);
  var result = axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(edamam).then(function (res) {
    console.log(res);
    return res;
  }).then(function (res) {
    return rendercards(res.data.hits);
  });
  debugger;
};
...
var rendercards = function rendercards(data) {
  debugger;
  document.getElementById('cards-container').innerHTML = data.map(function (el) {
    debugger;
    return "<div id=\"search-result-container\">\n                <img src='".concat(el.recipe.image, "'>\n                <h1> <span>Name</span> ").concat(el.recipe.label, " </h1>\n                <h1> <span>Calories</span> ").concat(el.recipe.calories, " </h1>\n                <form target=\"_blank\" action=\"").concat(el.recipe.url, "\">\n                    <input type=\"submit\" value=\"Go to Recipe\" />\n                </form>\n            </div>");
  });
};

var testSearch = function testSearch() {
  debugger;
  var searchInput = document.getElementById('search-bar-submit-button');
